...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:$t,depthTest:!1,depthWrite:!1})}function Ga(){return new Dt({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Gs(),fragmentShader:`
		...
		`,blending:$t,depthTest:!1,depthWrite:!1})}function Va(){return new Dt({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Gs(),fragmentShader:`
		...
		`,blending:$t,depthTest:!1,depthWrite:!1})}function Gs(){return`
 ...
 * @license Zlib
 */var lm="varying vec2 vUv;void main(){vUv=position.xy*0.5+0.5;gl_Position=vec4(position.xy,1.0,1.0);}",Re={SKIP:9,SET:30,ADD:0,ALPHA:1,AVERAGE:2,COLOR:3,COLOR_BURN:4,COLOR_DODGE:5,DARKEN:6,DIFFERENCE:7,DIVIDE:8,DST:9,EXCLUSION:10,HARD_LIGHT:11,HARD_MIX:12,HUE:13,INVERT:14,INVERT_RGB:15,LIGHTEN:16,LINEAR_BURN:17,LINEAR_DODGE:18,LINEAR_LIGHT:19,LUMINOSITY:20,MULTIPLY:21,NEGATION:22,NORMAL:23,OVERLAY:24,PIN_LIGHT:25,REFLECT:26,SATURATION:27,SCREEN:28,SOFT_LIGHT:29,SRC:30,SUBTRACT:31,VIVID_LIGHT:32},Hn={NONE:0,DEPTH:1,CONVOLUTION:2},Ie={FRAGMENT_HEAD:"FRAGMENT_HEAD",FRAGMENT_MAIN_UV:"FRAGMENT_MAIN_UV",FRAGMENT_MAIN_IMAGE:"FRAGMENT_MAIN_IMAGE",VERTEX_HEAD:"VERTEX_HEAD",VERTEX_MAIN_SUPPORT:"VERTEX_MAIN_SUPPORT"},cm=`#include <common>
#include <dithering_pars_fragment>
...
#include <encodings_fragment>
#include <dithering_fragment>
}`,hm=class extends Dt{constructor(){super({name:"CopyMaterial",uniforms:{inputBuffer:new pe(null),opacity:new pe(1)},blending:$t,depthWrite:!1,depthTest:!1,fragmentShader:cm,vertexShader:lm}),this.toneMapped=!1}set inputBuffer(i){this.uniforms.inputBuffer.value=i}setInputBuffer(i){this.uniforms.inputBuffer.value=i}getOpacity(i){return this.uniforms.opacity.value}setOpacity(i){this.uniforms.opacity.value=i}},um=`#include <common>
#include <packing>
#include <dithering_pars_fragment>
...
#endif
#include <dithering_fragment>
}`,dm="uniform vec2 resolution;uniform vec2 texelSize;uniform float cameraNear;uniform float cameraFar;uniform float aspect;uniform float time;varying vec2 vUv;VERTEX_HEADvoid main(){vUv=position.xy*0.5+0.5;VERTEX_MAIN_SUPPORTgl_Position=vec4(position.xy,1.0,1.0);}",fm=class extends Dt{constructor(i,e,t,n,r=!1){super({name:"EffectMaterial",defines:{THREE_REVISION:Ui.replace(/\D+/g,""),DEPTH_PACKING:"0",ENCODE_OUTPUT:"1"},uniforms:{inputBuffer:new pe(null),depthBuffer:new pe(null),resolution:new pe(new fe),texelSize:new pe(new fe),cameraNear:new pe(.3),cameraFar:new pe(1e3),aspect:new pe(1),time:new pe(0)},blending:$t,depthWrite:!1,depthTest:!1,dithering:r}),this.toneMapped=!1,i&&this.setShaderParts(i),e&&this.setDefines(e),t&&this.setUniforms(t),this.adoptCameraSettings(n)}set inputBuffer(i){this.uniforms.inputBuffer.value=i}setInputBuffer(i){this.uniforms.inputBuffer.value=i}get depthBuffer(){return this.uniforms.depthBuffer.value}set depthBuffer(i){this.uniforms.depthBuffer.value=i}get depthPacking(){return Number(this.defines.DEPTH_PACKING)}set depthPacking(i){this.defines.DEPTH_PACKING=i.toFixed(0),this.needsUpdate=!0}setDepthBuffer(i,e=ki){this.depthBuffer=i,this.depthPacking=e}setShaderData(i){this.setShaderParts(i.shaderParts),this.setDefines(i.defines),this.setUniforms(i.uniforms),this.setExtensions(i.extensions)}setShaderParts(i){var e,t,n,r,s;return this.fragmentShader=um.replace(Ie.FRAGMENT_HEAD,(e=i.get(Ie.FRAGMENT_HEAD))!=null?e:"").replace(Ie.FRAGMENT_MAIN_UV,(t=i.get(Ie.FRAGMENT_MAIN_UV))!=null?t:"").replace(Ie.FRAGMENT_MAIN_IMAGE,(n=i.get(Ie.FRAGMENT_MAIN_IMAGE))!=null?n:""),this.vertexShader=dm.replace(Ie.VERTEX_HEAD,(r=i.get(Ie.VERTEX_HEAD))!=null?r:"").replace(Ie.VERTEX_MAIN_SUPPORT,(s=i.get(Ie.VERTEX_MAIN_SUPPORT))!=null?s:""),this.needsUpdate=!0,this}setDefines(i){for(const e of i.entries())this.defines[e[0]]=e[1];return this.needsUpdate=!0,this}setUniforms(i){for(const e of i.entries())this.uniforms[e[0]]=e[1];return this}setExtensions(i){this.extensions={};for(const e of i)this.extensions[e]=!0;return this}get encodeOutput(){return this.defines.ENCODE_OUTPUT!==void 0}set encodeOutput(i){this.encodeOutput!==i&&(i?this.defines.ENCODE_OUTPUT="1":delete this.defines.ENCODE_OUTPUT,this.needsUpdate=!0)}isOutputEncodingEnabled(i){return this.encodeOutput}setOutputEncodingEnabled(i){this.encodeOutput=i}get time(){return this.uniforms.time.value}set time(i){this.uniforms.time.value=i}setDeltaTime(i){this.uniforms.time.value+=i}adoptCameraSettings(i){i&&(this.uniforms.cameraNear.value=i.near,this.uniforms.cameraFar.value=i.far,i instanceof Mt?this.defines.PERSPECTIVE_CAMERA="1":delete this.defines.PERSPECTIVE_CAMERA,this.needsUpdate=!0)}setSize(i,e){const t=this.uniforms;t.resolution.value.set(i,e),t.texelSize.value.set(1/i,1/e),t.aspect.value=i/e}static get Section(){return Ie}},pm=new Us,Sn=null;function mm(){if(Sn===null){const i=new Float32Array([-1,-1,0,3,-1,0,-1,3,0]),e=new Float32Array([0,0,2,0,0,2]);Sn=new _t,Sn.setAttribute!==void 0?(Sn.setAttribute("position",new St(i,3)),Sn.setAttribute("uv",new St(e,2))):(Sn.addAttribute("position",new St(i,3)),Sn.addAttribute("uv",new St(e,2)))}return Sn}var Ut=class{constructor(i="Pass",e=new Rs,t=pm){this.name=i,this.renderer=null,this.scene=e,this.camera=t,this.screen=null,this.rtt=!0,this.needsSwap=!0,this.needsDepthTexture=!1,this.enabled=!0}get renderToScreen(){return!this.rtt}set renderToScreen(i){if(this.rtt===i){const e=this.fullscreenMaterial;e!==null&&(e.needsUpdate=!0),this.rtt=!i}}setRenderer(i){this.renderer=i}isEnabled(){return this.enabled}setEnabled(i){this.enabled=i}get fullscreenMaterial(){return this.screen!==null?this.screen.material:null}set fullscreenMaterial(i){let e=this.screen;e!==null?e.material=i:(e=new le(mm(),i),e.frustumCulled=!1,this.scene===null&&(this.scene=new Rs),this.scene.add(e),this.screen=e)}getFullscreenMaterial(){return this.fullscreenMaterial}setFullscreenMaterial(i){this.fullscreenMaterial=i}getDepthTexture(){return null}setDepthTexture(i,e=ki){}render(i,e,t,n,r){throw new Error("Render method not implemented!")}setSize(i,e){}initialize(i,e,t){}dispose(){for(const i of Object.keys(this)){const e=this[i];(e instanceof st||e instanceof Tn||e instanceof ct||e instanceof Ut)&&this[i].dispose()}}},gm=class extends Ut{constructor(i,e=!0){super("CopyPass"),this.fullscreenMaterial=new hm,this.needsSwap=!1,this.renderTarget=i,i===void 0&&(this.renderTarget=new st(1,1,{minFilter:Se,magFilter:Se,stencilBuffer:!1,depthBuffer:!1}),this.renderTarget.texture.name="CopyPass.Target"),this.autoResize=e}get resize(){return this.autoResize}set resize(i){this.autoResize=i}get texture(){return this.renderTarget.texture}getTexture(){return this.renderTarget.texture}setAutoResizeEnabled(i){this.autoResize=i}render(i,e,t,n,r){this.fullscreenMaterial.inputBuffer=e.texture,i.setRenderTarget(this.renderToScreen?null:this.renderTarget),i.render(this.scene,this.camera)}setSize(i,e){this.autoResize&&this.renderTarget.setSize(i,e)}initialize(i,e,t){t!==void 0&&(this.renderTarget.texture.type=t,t!==Xt?this.fullscreenMaterial.defines.FRAMEBUFFER_PRECISION_HIGH="1":i.outputEncoding===Ne&&(this.renderTarget.texture.encoding=Ne))}},_m=class extends Ut{constructor(){super("ClearMaskPass",null,null),this.needsSwap=!1}render(i,e,t,n,r){const s=i.state.buffers.stencil;s.setLocked(!1),s.setTest(!1)}},gs=new Fe,cl=class extends Ut{constructor(i=!0,e=!0,t=!1){super("ClearPass",null,null),this.needsSwap=!1,this.color=i,this.depth=e,this.stencil=t,this.overrideClearColor=null,this.overrideClearAlpha=-1}setClearFlags(i,e,t){this.color=i,this.depth=e,this.stencil=t}getOverrideClearColor(){return this.overrideClearColor}setOverrideClearColor(i){this.overrideClearColor=i}getOverrideClearAlpha(){return this.overrideClearAlpha}setOverrideClearAlpha(i){this.overrideClearAlpha=i}render(i,e,t,n,r){const s=this.overrideClearColor,a=this.overrideClearAlpha,o=i.getClearAlpha(),c=s!==null,l=a>=0;c?(gs.copy(i.getClearColor(gs)),i.setClearColor(s,l?a:o)):l&&i.setClearAlpha(a),i.setRenderTarget(this.renderToScreen?null:e),i.clear(this.color,this.depth,this.stencil),c?i.setClearColor(gs,o):l&&i.setClearAlpha(o)}},wn=-1,_s=class extends Qt{constructor(i,e=wn,t=wn,n=1){super(),this.resizable=i,this.baseSize=new fe(1,1),this.preferredSize=new fe(e,t),this.target=this.preferredSize,this.s=n,this.effectiveSize=new fe,this.addEventListener("change",()=>this.updateEffectiveSize()),this.updateEffectiveSize()}updateEffectiveSize(){const i=this.baseSize,e=this.preferredSize,t=this.effectiveSize,n=this.scale;e.width!==wn?t.width=e.width:e.height!==wn?t.width=Math.round(e.height*(i.width/Math.max(i.height,1))):t.width=Math.round(i.width*n),e.height!==wn?t.height=e.height:e.width!==wn?t.height=Math.round(e.width/Math.max(i.width/Math.max(i.height,1),1)):t.height=Math.round(i.height*n)}get width(){return this.effectiveSize.width}set width(i){this.preferredWidth=i}get height(){return this.effectiveSize.height}set height(i){this.preferredHeight=i}getWidth(){return this.width}getHeight(){return this.height}get scale(){return this.s}set scale(i){this.s!==i&&(this.s=i,this.preferredSize.setScalar(wn),this.dispatchEvent({type:"change"}),this.resizable.setSize(this.baseSize.width,this.baseSize.height))}getScale(){return this.scale}setScale(i){this.scale=i}get baseWidth(){return this.baseSize.width}set baseWidth(i){this.baseSize.width!==i&&(this.baseSize.width=i,this.dispatchEvent({type:"change"}),this.resizable.setSize(this.baseSize.width,this.baseSize.height))}getBaseWidth(){return this.baseWidth}setBaseWidth(i){this.baseWidth=i}get baseHeight(){return this.baseSize.height}set baseHeight(i){this.baseSize.height!==i&&(this.baseSize.height=i,this.dispatchEvent({type:"change"}),this.resizable.setSize(this.baseSize.width,this.baseSize.height))}getBaseHeight(){return this.baseHeight}setBaseHeight(i){this.baseHeight=i}setBaseSize(i,e){(this.baseSize.width!==i||this.baseSize.height!==e)&&(this.baseSize.set(i,e),this.dispatchEvent({type:"change"}),this.resizable.setSize(this.baseSize.width,this.baseSize.height))}get preferredWidth(){return this.preferredSize.width}set preferredWidth(i){this.preferredSize.width!==i&&(this.preferredSize.width=i,this.dispatchEvent({type:"change"}),this.resizable.setSize(this.baseSize.width,this.baseSize.height))}getPreferredWidth(){return this.preferredWidth}setPreferredWidth(i){this.preferredWidth=i}get preferredHeight(){return this.preferredSize.height}set preferredHeight(i){this.preferredSize.height!==i&&(this.preferredSize.height=i,this.dispatchEvent({type:"change"}),this.resizable.setSize(this.baseSize.width,this.baseSize.height))}getPreferredHeight(){return this.preferredHeight}setPreferredHeight(i){this.preferredHeight=i}setPreferredSize(i,e){(this.preferredSize.width!==i||this.preferredSize.height!==e)&&(this.preferredSize.set(i,e),this.dispatchEvent({type:"change"}),this.resizable.setSize(this.baseSize.width,this.baseSize.height))}copy(i){this.s=i.scale,this.baseSize.set(i.getBaseWidth(),i.getBaseHeight()),this.preferredSize.set(i.getPreferredWidth(),i.getPreferredHeight()),this.dispatchEvent({type:"change"}),this.resizable.setSize(this.baseSize.width,this.baseSize.height)}static get AUTO_SIZE(){return wn}},vs=!1,To=class{constructor(i=null){this.originalMaterials=new Map,this.material=null,this.materials=null,this.materialsBackSide=null,this.materialsDoubleSide=null,this.materialsFlatShaded=null,this.materialsFlatShadedBackSide=null,this.materialsFlatShadedDoubleSide=null,this.setMaterial(i),this.meshCount=0,this.replaceMaterial=e=>{if(e.isMesh){let t;if(e.material.flatShading)switch(e.material.side){case Ht:t=this.materialsFlatShadedDoubleSide;break;case gt:t=this.materialsFlatShadedBackSide;break;default:t=this.materialsFlatShaded;break}else switch(e.material.side){case Ht:t=this.materialsDoubleSide;break;case gt:t=this.materialsBackSide;break;default:t=this.materials;break}this.originalMaterials.set(e,e.material),e.isSkinnedMesh?e.material=t[2]:e.isInstancedMesh?e.material=t[1]:e.material=t[0],++this.meshCount}}}setMaterial(i){if(this.disposeMaterials(),this.material=i,i!==null){const e=this.materials=[i.clone(),i.clone(),i.clone()];for(const t of e)t.uniforms=Object.assign({},i.uniforms),t.side=mi;e[2].skinning=!0,this.materialsBackSide=e.map(t=>{const n=t.clone();return n.uniforms=Object.assign({},i.uniforms),n.side=gt,n}),this.materialsDoubleSide=e.map(t=>{const n=t.clone();return n.uniforms=Object.assign({},i.uniforms),n.side=Ht,n}),this.materialsFlatShaded=e.map(t=>{const n=t.clone();return n.uniforms=Object.assign({},i.uniforms),n.flatShading=!0,n}),this.materialsFlatShadedBackSide=e.map(t=>{const n=t.clone();return n.uniforms=Object.assign({},i.uniforms),n.flatShading=!0,n.side=gt,n}),this.materialsFlatShadedDoubleSide=e.map(t=>{const n=t.clone();return n.uniforms=Object.assign({},i.uniforms),n.flatShading=!0,n.side=Ht,n})}}render(i,e,t){const n=i.shadowMap.enabled;if(i.shadowMap.enabled=!1,vs){const r=this.originalMaterials;this.meshCount=0,e.traverse(this.replaceMaterial),i.render(e,t);for(const s of r)s[0].material=s[1];this.meshCount!==r.size&&r.clear()}else{const r=e.overrideMaterial;e.overrideMaterial=this.material,i.render(e,t),e.overrideMaterial=r}i.shadowMap.enabled=n}disposeMaterials(){if(this.material!==null){const i=this.materials.concat(this.materialsBackSide).concat(this.materialsDoubleSide).concat(this.materialsFlatShaded).concat(this.materialsFlatShadedBackSide).concat(this.materialsFlatShadedDoubleSide);for(const e of i)e.dispose()}}dispose(){this.originalMaterials.clear(),this.disposeMaterials()}static get workaroundEnabled(){return vs}static set workaroundEnabled(i){vs=i}},Ws=class extends Ut{constructor(i,e,t=null){super("RenderPass",i,e),this.needsSwap=!1,this.clearPass=new cl,this.overrideMaterialManager=t===null?null:new To(t),this.ignoreBackground=!1,this.skipShadowMapUpdate=!1,this.selection=null}get renderToScreen(){return super.renderToScreen}set renderToScreen(i){super.renderToScreen=i,this.clearPass.renderToScreen=i}get overrideMaterial(){const i=this.overrideMaterialManager;return i!==null?i.material:null}set overrideMaterial(i){const e=this.overrideMaterialManager;i!==null?e!==null?e.setMaterial(i):this.overrideMaterialManager=new To(i):e!==null&&(e.dispose(),this.overrideMaterialManager=null)}getOverrideMaterial(){return this.overrideMaterial}setOverrideMaterial(i){this.overrideMaterial=i}get clear(){return this.clearPass.enabled}set clear(i){this.clearPass.enabled=i}getSelection(){return this.selection}setSelection(i){this.selection=i}isBackgroundDisabled(){return this.ignoreBackground}setBackgroundDisabled(i){this.ignoreBackground=i}isShadowMapDisabled(){return this.skipShadowMapUpdate}setShadowMapDisabled(i){this.skipShadowMapUpdate=i}getClearPass(){return this.clearPass}render(i,e,t,n,r){const s=this.scene,a=this.camera,o=this.selection,c=a.layers.mask,l=s.background,h=i.shadowMap.autoUpdate,u=this.renderToScreen?null:e;o!==null&&a.layers.set(o.getLayer()),this.skipShadowMapUpdate&&(i.shadowMap.autoUpdate=!1),(this.ignoreBackground||this.clearPass.overrideClearColor!==null)&&(s.background=null),this.clearPass.enabled&&this.clearPass.render(i,e),i.setRenderTarget(u),this.overrideMaterialManager!==null?this.overrideMaterialManager.render(i,s,a):i.render(s,a),a.layers.mask=c,s.background=l,i.shadowMap.autoUpdate=h}},vm=class extends Ut{constructor(i,e,{renderTarget:t,resolutionScale:n=1,width:r=_s.AUTO_SIZE,height:s=_s.AUTO_SIZE,resolutionX:a=r,resolutionY:o=s}={}){super("DepthPass"),this.needsSwap=!1,this.renderPass=new Ws(i,e,new nl({depthPacking:ko}));const c=this.renderPass;c.skipShadowMapUpdate=!0,c.ignoreBackground=!0;const l=c.getClearPass();l.overrideClearColor=new Fe(16777215),l.overrideClearAlpha=1,this.renderTarget=t,this.renderTarget===void 0&&(this.renderTarget=new st(1,1,{minFilter:je,magFilter:je}),this.renderTarget.texture.name="DepthPass.Target");const h=this.resolution=new _s(this,a,o,n);h.addEventListener("change",u=>this.setSize(h.baseWidth,h.baseHeight))}get texture(){return this.renderTarget.texture}getTexture(){return this.renderTarget.texture}getResolution(){return this.resolution}getResolutionScale(){return this.resolution.scale}setResolutionScale(i){this.resolution.scale=i}render(i,e,t,n,r){const s=this.renderToScreen?null:this.renderTarget;this.renderPass.render(i,s)}setSize(i,e){const t=this.resolution;t.setBaseSize(i,e),this.renderTarget.setSize(t.width,t.height)}};function Ao(i,e,t){for(const n of e){const r="$1"+i+n.charAt(0).toUpperCase()+n.slice(1),s=new RegExp("([^\\.])(\\b"+n+"\\b)","g");for(const a of t.entries())a[1]!==null&&t.set(a[0],a[1].replace(s,r))}}function xm(i,e,t){var n,r,s,a,o;let c=e.getFragmentShader(),l=e.getVertexShader();const h=c!==void 0&&/mainImage/.test(c),u=c!==void 0&&/mainUv/.test(c);if(t.attributes|=e.getAttributes(),c===void 0)throw new Error(`Missing fragment shader (${e.name})`);if(u&&(t.attributes&Hn.CONVOLUTION)!==0)throw new Error(`Effects that transform UVs are incompatible with convolution effects (${e.name})`);if(!h&&!u)throw new Error(`Could not find mainImage or mainUv function (${e.name})`);{const f=/\w+\s+(\w+)\([\w\s,]*\)\s*{/g,m=t.shaderParts;let x=(n=m.get(Ie.FRAGMENT_HEAD))!=null?n:"",p=(r=m.get(Ie.FRAGMENT_MAIN_UV))!=null?r:"",d=(s=m.get(Ie.FRAGMENT_MAIN_IMAGE))!=null?s:"",g=(a=m.get(Ie.VERTEX_HEAD))!=null?a:"",v=(o=m.get(Ie.VERTEX_MAIN_SUPPORT))!=null?o:"";const b=new Set,M=new Set;if(u&&(p+=`	${i}MainUv(UV);
...
`;for(const _ of l.matchAll(/(?:varying\s+\w+\s+(\w*))/g))t.varyings.add(_[1]),b.add(_[1]),M.add(_[1]);for(const _ of l.matchAll(f))M.add(_[1])}for(const L of c.matchAll(f))M.add(L[1]);for(const L of e.defines.keys())M.add(L.replace(/\([\w\s,]*\)/g,""));for(const L of e.uniforms.keys())M.add(L);M.delete("while"),M.delete("for"),M.delete("if"),e.uniforms.forEach((L,_)=>t.uniforms.set(i+_.charAt(0).toUpperCase()+_.slice(1),L)),e.defines.forEach((L,_)=>t.defines.set(i+_.charAt(0).toUpperCase()+_.slice(1),L));const y=new Map([["fragment",c],["vertex",l]]);Ao(i,M,t.defines),Ao(i,M,y),c=y.get("fragment"),l=y.get("vertex");const A=e.blendMode;if(t.blendModes.set(A.blendFunction,A),h){e.inputColorSpace!==null&&e.inputColorSpace!==t.colorSpace&&(d+=e.inputColorSpace===Ne?`color0 = LinearTosRGB(color0);
	...
	`),e.outputColorSpace!==null?t.colorSpace=e.outputColorSpace:e.inputColorSpace!==null&&(t.colorSpace=e.inputColorSpace);const L=/MainImage *\([\w\s,]*?depth[\w\s,]*?\)/;d+=`${i}MainImage(color0, UV, `,(t.attributes&Hn.DEPTH)!==0&&L.test(c)&&(d+="depth, ",t.readDepth=!0),d+=`color1);
...
#endif
if(alpha==1.0){outputColor=accumulatedColor;}else{float m=mix(alpha,1.0,blend);if(needsBlur)m=0.0;outputColor=accumulatedColor*m+inputColor*(1.0-m);}`;class ug extends Dt{constructor(){super({type:"MRTMaterial",defines:{USE_UV:"",TEMPORAL_RESOLVE:""},uniforms:{opacity:new pe(1),normalMap:new pe(null),normalScale:new pe(new fe(1,1)),uvTransform:new pe(new Pt),roughness:new pe(1),roughnessMap:new pe(null)},vertexShader:`
                #ifdef USE_MRT
                 varying vec2 vHighPrecisionZW;
                #endif
                #define NORMAL
...
gl_FragColor=vec4(undoColorTransform(outputColor),alpha);}`;class yg extends Dt{constructor(e){const t=xg.replace("#include <custom_compose_shader>",e);super({type:"TemporalResolveMaterial",uniforms:{inputTexture:new pe(null),accumulatedTexture:new pe(null),velocityTexture:new pe(null),lastVelocityTexture:new pe(null),samples:new pe(1),blend:new pe(.5),correction:new pe(1),exponent:new pe(1),invTexSize:new pe(new fe)},defines:{correctionRadius:1},vertexShader:vg,fragmentShader:t})}}const Mg=`
		#ifdef USE_SKINNING
		#ifdef BONE_TEXTURE
...
`;class Sg extends Dt{constructor(){super({uniforms:{prevVelocityMatrix:{value:new ze},velocityMatrix:{value:new ze},prevBoneTexture:{value:null},interpolateGeometry:{value:0},intensity:{value:1},boneTexture:{value:null},alphaTest:{value:0},map:{value:null},alphaMap:{value:null},opacity:{value:1}},vertexShader:`
...
`;continue}if((P=D.match(y))&&(T.gamma=parseFloat(P[1])),(P=D.match(A))&&(T.exposure=parseFloat(P[1])),(P=D.match(L))&&(T.valid|=2,T.format=P[1]),(P=D.match(_))&&(T.valid|=4,T.height=parseInt(P[1],10),T.width=parseInt(P[2],10)),T.valid&2&&T.valid&4)break}return T.valid&2?T.valid&4?T:o(3,"missing image size specifier"):o(3,"missing format specifier")},x=function(b,M,y){const A=M;if(A<8||A>32767||b[0]!==2||b[1]!==2||b[2]&128)return new Uint8Array(b);if(A!==(b[2]<<8|b[3]))return o(3,"wrong scanline width");const L=new Uint8Array(4*M*y);if(!L.length)return o(4,"unable to allocate buffer space");let _=0,T=0;const D=4*A,P=new Uint8Array(4),Y=new Uint8Array(D);let $=y;for(;$>0&&T<b.byteLength;){if(T+4>b.byteLength)return o(1);if(P[0]=b[T++],P[1]=b[T++],P[2]=b[T++],P[3]=b[T++],P[0]!=2||P[1]!=2||(P[2]<<8|P[3])!=A)return o(3,"bad rgbe scanline format");let F=0,B;for(;F<D&&T<b.byteLength;){B=b[T++];const G=B>128;if(G&&(B-=128),B===0||F+B>D)return o(3,"bad scanline data");if(G){const V=b[T++];for(let N=0;N<B;N++)Y[F++]=V}else Y.set(b.subarray(T,T+B),F),F+=B,T+=B}const U=A;for(let G=0;G<U;G++){let V=0;L[_]=Y[G+V],V+=A,L[_+1]=Y[G+V],V+=A,L[_+2]=Y[G+V],V+=A,L[_+3]=Y[G+V],_+=4}$--}return L},p=function(b,M,y,A){const L=b[M+3],_=Math.pow(2,L-128)/255;y[A+0]=b[M+0]*_,y[A+1]=b[M+1]*_,y[A+2]=b[M+2]*_,y[A+3]=1},d=function(b,M,y,A){const L=b[M+3],_=Math.pow(2,L-128)/255;y[A+0]=ur.toHalfFloat(Math.min(b[M+0]*_,65504)),y[A+1]=ur.toHalfFloat(Math.min(b[M+1]*_,65504)),y[A+2]=ur.toHalfFloat(Math.min(b[M+2]*_,65504)),y[A+3]=ur.toHalfFloat(1)},g=new Uint8Array(e);g.pos=0;const v=m(g);if(v!==-1){const b=v.width,M=v.height,y=x(g.subarray(g.pos),b,M);if(y!==-1){let A,L,_;switch(this.type){case Wt:_=y.length/4;const T=new Float32Array(_*4);for(let P=0;P<_;P++)p(y,P*4,T,P*4);A=T,L=Wt;break;case bt:_=y.length/4;const D=new Uint16Array(_*4);for(let P=0;P<_;P++)d(y,P*4,D,P*4);A=D,L=bt;break;default:console.error("THREE.RGBELoader: unsupported type: ",this.type);break}return{width:b,height:M,data:A,header:v.string,gamma:v.gamma,exposure:v.exposure,type:L}}}return null}setDataType(e){return this.type=e,this}load(e,t,n,r){function s(a,o){switch(a.type){case Wt:case bt:a.encoding=Kt,a.minFilter=Se,a.magFilter=Se,a.generateMipmaps=!1,a.flipY=!0;break}t&&t(a,o)}return super.load(e,s,n,r)}}const ui={useComposer:!1,addTransformControls:!1,useSelection:!1,selectionFloor:!1,selectionObjects:!1,useHDRI:!1},Bg=new Ug;let Is,Un;const dl=[],An=new rl;An.setSize(window.innerWidth,window.innerHeight);document.body.appendChild(An.domElement);An.toneMapping=Oo;const Ot=new Rs,un=new Mt(75,window.innerWidth/window.innerHeight,.1,1e3);un.position.set(0,3,-8);const fl=new Gp(un,An.domElement);fl.update();const pl=new Np;pl.position.set(1,2,1);Ot.add(pl);const Xs=new wm(An);Xs.addPass(new Ws(Ot,un));const Fi=new Og(Ot,un),kg=new ym(un,Fi);Xs.addPass(kg);const Sr=new Vp(un,An.domElement);Sr.addEventListener("dragging-changed",i=>{fl.enabled=!i.value});function ml(){requestAnimationFrame(ml),ui.useComposer?Xs.render():An.render(Ot,un)}function Gg(){for(let i=0;i<10;i++){const e=Math.random()>.5?new Ke(1,1,1):new Cr(.5),t=new ol({color:16777215,roughness:0});t.color.setHSL(Math.random(),.6,.6);const n=new le(e,t);n.position.x=Ea.randFloat(-5,5),n.position.z=Ea.randFloat(-5,5),n.position.y=1,Ot.add(n),Sr.attach(n),dl.push(n)}}function Vg(){const i=new Vi(10,10);i.rotateX(-Math.PI/2);const e=new ol({color:7393161,roughness:0,metalness:0});e.color.setHSL(Math.random(),.6,.6);const t=new le(i,e);Ot.add(t),Is=t}function Hg(){const i=new Hs({title:"SSR 2.5.0"});i.add(ui,"useComposer").name("Composer + SSR"),i.add(ui,"useHDRI").onChange(e=>{Wg(e)}),i.add(ui,"addTransformControls").onChange(e=>{e?Ot.add(Sr):Ot.remove(Sr)}),i.add(ui,"selectionFloor").onChange(e=>{e?Fi.selection.add(Is):Fi.selection.delete(Is)}),i.add(ui,"selectionObjects").onChange(e=>{for(const t of dl)e?Fi.selection.add(t):Fi.selection.delete(t)}),Ot.environment=Un,Ot.background=Un}async function Wg(i){Un||(Un=await Bg.loadAsync("https://threejs.org/examples/textures/equirectangular/blouberg_sunrise_2_1k.hdr"),Un.mapping=xr),Ot.environment=i?Un:null,Ot.background=i?Un:null}window.onresize=()=>{An.setSize(window.innerWidth,window.innerHeight),un.aspect=window.innerWidth/window.innerHeight,un.updateProjectionMatrix()};Gg();Vg();Hg();ml();
